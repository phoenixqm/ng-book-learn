...
!angular.$$csp() && angular.element(document).find('head')
  .prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],'+
    '[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,'+
    '.ng-hide{display:none !important;}ng\\:form{display:block;}'+
    '.ng-animate-start{clip:rect(0,auto,auto,0);-ms-zoom:1.0001;}'+
    '.ng-animate-active{clip:rect(-1px,auto,auto,0);-ms-zoom:1;}</style>');